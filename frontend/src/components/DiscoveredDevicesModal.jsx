          ...
          {discoveredDevices.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              {discoveredDevices.map(device => (
                <div 
                  key={device.id} 
                  className="bg-background border border-border-secondary rounded-lg p-4 hover:border-border-primary transition-colors"
                >
                  {/* Device Header */}
                  ...
                  <button
                    ...
                    className="w-full px-3 py-2 bg-primary text-white text-sm rounded-md hover:opacity-80 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                  >
        ...
        <div className="flex items-center justify-between p-6 border-t border-border-secondary bg-surface-hover">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="px-4 py-2 bg-accent text-white rounded-md hover:opacity-80 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
              {isRescanning ? (
                <>
                  <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 bg-background border border-border-secondary text-text rounded-md hover:bg-surface-hover transition-colors"
            >
              Close
            </button>
          </div>
